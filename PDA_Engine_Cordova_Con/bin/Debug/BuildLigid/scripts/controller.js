...
{%if para.DefaultValueSource == 'form' -%}
SetDefaultValue(Entity.Parameters,'{{para.name}}',Para('{{para.DefaultValueParameter}}'));
{% endif -%}
{%if para.DefaultValueSource == 'Expr' -%}
SetDefaultValue(Entity.Parameters,'{{para.name}}', {{para.DefaultValueParameter}});
{% endif -%}
{%if para.DefaultValueSource == 'Static' -%}
SetDefaultValue(Entity.Parameters,'{{para.name}}', {{para.DefaultValueParameter}});
{% endif -%}
{%if para.DefaultValueSource == 'NULL' -%}
SetDefaultValue(Entity.Parameters,'{{para.name}}',null);
{% endif -%}
...
{{Page.name}}.Serach=function(obj,dataP)
{
    ...
    Entity.Parameters.push( toInput('{{para.name}}',  NorDate($('#txt{{Page.name}}{{para.name}}').val())  ) );
    {% elseif (para.type == 'CheckBox') -%}
    Entity.Parameters.push( toInput('{{para.name}}',  ConvertBit($('#txt{{Page.name}}{{para.name}}').val())  ) );
